...
public class Principal {
	...
	public static void main(String[]args) {
		...
		Caja dinero[] = {new  Caja("Caja1","Cajero1",0), new  Caja("Caja2","Cajero2",55), new  Caja("Caja3","Cajero3",20) };		
		...
		System.out.println(persona2.getNombre() + " pasar por " + dinero[0].getId() + " y retira 50€");
		System.out.println(persona2.retirar(dinero));
